...
router.get('/search/object/:tms/:id', ensureLoggedIn, search.object.index)
router.get('/search/event/:tms/:id', ensureLoggedIn, search.event.index)
router.get('/search/exhibition/:tms/:id', ensureLoggedIn, search.exhibition.index)
